...
/*:
To complete a todo item, we need to create a new copy of the todo item, with the opposite value for the completed property.
Note the functional aspect of this function. A value is placed in, transformed, and a new one is returned with no unwanted side effects (such as mutating the original todoItem). This would be really easy to test.
*/
